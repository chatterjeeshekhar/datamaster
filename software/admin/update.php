...
$sql ="update boss set fname='$fname', lname='$lname', email='$useremail', address='$address', city='$city', country='$country', tel='$tel' where username='$userac';";
                 ...
                 <!-- <p class="text-muted text-center">Software Engineer</p>-->
                  ...
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Status</b> <a class="pull-right">Administrator</a>
                    </li>
                    <li class="list-group-item">
                      <b>Balance</b> <a class="pull-right"><?php echo $_SESSION['user_balance']; ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>Emails Delivered</b> <a class="pull-right"><?php echo $_SESSION['user_total']; ?></a>
                    </li>
...
$con=mysqli_connect($servername1, $username1, $password1, $dbname1);
$userac = $_SESSION['login_user'];
$query = mysqli_query($con,"update boss set password=md5('$newpas') where username='$userac' and password=md5('$curpas')");
$rows = mysqli_affected_rows($con);
if($rows > 0)
{echo '<script>alert("Password successfully changed")</script>'; echo "<script>window.location.href = window.location.href;</script>";}
...
<!-- Ends Change Password Script -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" name="newpas" class="form-control" id="inputEmail" placeholder="New Password">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">Repeat</label>
                        <div class="col-sm-10">
                          <input type="password" name="newpas1" placeholder="Repeat New Password" class="form-control" id="inputEmail">
                        </div>
                      </div>
                       <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
