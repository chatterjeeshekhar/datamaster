...
$transid1 = "Self-recharge - ".rand(100000000, 9999999999);
...
echo "<input type='text' name='users' class='form-control' value='$limita' disabled='disabled'>"?>
...
<input type="hidden" name="otherinfo" value="1">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="Submit" id="Submit" value="Continue" class="btn btn-primary"><i class="fa fa-money"></i>  Recharge Now</button> <a class="btn btn-default" href=""><i class="fa fa-refresh"></i>  Refresh</a>
                  </div>
                </form> 
